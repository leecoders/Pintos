...
bool
thread_check_priority(const struct list_elem *a, const struct list_elem *b, void *aux UNUSED)
{
...
thread_hold_lock(struct lock *lock)
{
  ...
  list_insert_ordered(&cur->locks_holding, &lock->elem, lock_check_priority, NULL);
...
bool
lock_check_priority(const struct list_elem *a, const struct list_elem *b, void *aux UNUSED)
{
  return list_entry(a, struct lock, elem)->max_priority > list_entry(b, struct lock, elem)
         ->max_priority;
}
...
thread_update_priority(struct thread *t)
{
  ...
  {
    list_sort(&t->locks_holding, lock_check_priority, NULL);
...
init_thread (struct thread *t, const char *name, int priority)
{
  ...
  old_level = intr_disable();
  list_insert_ordered(&all_list, &t->allelem, thread_check_priority, NULL);
